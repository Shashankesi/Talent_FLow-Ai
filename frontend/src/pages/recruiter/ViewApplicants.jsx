...
import { recruiterService, resumeService } from '../../services/api';
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold">
                          {app.user?.fullName || 'Unknown Candidate'}
                        </h3>
                    ...
                    <div className="mb-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm font-bold text-primary">{app.matchScore}%</span>
                      </div>
                  ...
                  <div className="text-right ml-4">
                    ...
                    {app.resumeId && (
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        type="button"
                        onClick={() => handleResumeDownload(app.resumeId)}
